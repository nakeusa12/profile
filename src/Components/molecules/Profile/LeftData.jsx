	...
	return (
		<div className='lg:w-1/4 md:w-1/2 w-full mb-4 md:mb-0'>
			...
			<div className='flex md:flex-col flex-row md:mt-0 mt-10'>
				<div className='md:w-full w-auto flex flex-row justify-center mt-12'>
					<a
						href='https://www.facebook.com/saifulnakeusa/'
						target='blank'
						className='mr-2'>
						<AiFillFacebook className='md:text-3xl text-4xl text-primary hover:text-gray-700' />
					</a>
					<a
						href='https://www.instagram.com/sfullnakeusa12/'
						target='blank'
						className='mr-2'>
						<AiFillInstagram className='md:text-3xl text-4xl text-primary hover:text-gray-700' />
					</a>
					<a
						href='https://github.com/nakeusa12'
						target='blank'
						className='mr-2'>
						<FaGithubSquare className='md:text-3xl text-4xl text-primary hover:text-gray-700' />
					</a>
					<a
						href='https://www.linkedin.com/in/saiful-nakeusa-99634b153/'
						target='blank'>
						<FaLinkedin className='md:text-3xl text-4xl text-primary hover:text-gray-700' />
					</a>
				</div>
				<div className='md:text-center w-full text-right mt-12'>
					<a
						className='px-6 hover:bg-gray-800 hover:text-second py-2 rounded border-solid border-2 border-primary'
						href='./cv-saifulnakeusa.pdf'
						download>
						Download CV
					</a>
				</div>
